...
import org.jb2011.lnf.beautyeye.ninepatch4j.NinePatch;
...
public class __Icon9Factory__ extends RawCache<NinePatch>
{
	...
	/**
	 * Gets the bg icon_ item selected.
	 *
	 * @return the bg icon_ item selected
	 */
	public NinePatch getBgIcon_ItemSelected()
	{
		return getRaw(IMGS_ROOT+"/menu_bg.9.png");
	}
}